...
export default function Home() {
  return ( 
    <>
    <title>Sravan</title>
    <div className='h-screen flex justify-left'>
      <div className='mt-28 divide-y divide-gray-200 max-w-3xl mx-16 '>
        <div className='space-y-18 pt-25 pb-20 md:space-y-5'>
          <section >
            <div className='container mx-auto flex flex-col items-left'>
              <div className='flex w-full flex-col items-start text-left'>
                ...
                <div className='space-y-1 pt-4 pb-6 md:space-y-3' />
                <section>
                  <div className='container mx-auto mb-6 flex flex-col'>
                    <h1 className='className="text-3xl text-white font-bold' >
                      Projects and experiments 
                    </h1>
                    <div className='flex w-full flex-col items-center border-b py-1 text-white md:flex-row'>
                      <div className='w-full'>
                      <p className='font-semibold https://twitter.com/text-gray-200'>
                     ...
                     <div className='space-y-2 pt-6 pb-8 md:space-y-5'/>
                      ...
                      <p className='mb-2 text-left font-serif text-base leading-relaxed text-gray-200 sm:text-lg'>
                      You can get in touch with through twitter
                      <a target='_blank'href='https://twitter.com/Sravan1011'>
                        <span className='underline underline-offset-'>
                          @Sravan1011
                        </span>
                      </a> 
